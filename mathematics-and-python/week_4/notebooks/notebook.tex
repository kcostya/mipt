...
Деммель. Вычислительная линейная алгебра. Теория и приложения (2001) ---
понятный кусок про матричные разложения. Математический анализ
...
\textbf{Теория вероятностей и статистика}
